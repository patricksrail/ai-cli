---
title: Introduction
description: Generate media and text, and make typed judgments from the terminal.
order: 1
---
...
<Cards>
  ...
  <Card title="Evaluation" description="Use AI SDK evaluation models with typed questions and JSON results." href="/docs/evaluate" />
...
<Cards>
  ...
  <Card title="evaluate" description="Evaluate named typed questions against shared stdin." href="/docs/evaluate" />
