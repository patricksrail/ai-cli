...
ai-cli is a tiny, agent-native CLI for generating text, images, video, and audio with dead-simple commands. It uses the [Vercel AI SDK](https://sdk.vercel.ai) with Vercel AI Gateway by default and supports Cloudflare AI Gateway provider-native routing.
...
<Steps>
  ...
  <Step>
    ...
    For Cloudflare setup, see [Installation](/docs/installation#gateway-access).
  </Step>
  <Step>
    ### Generate something
