...
<Properties>
  ...
  <Property name="CLOUDFLARE_API_TOKEN" type="string">
    Gateway authentication token. Required only when the selected Cloudflare gateway has authentication enabled.
  </Property>
  <Property name="OPENAI_API_KEY" type="string">
    Provider-specific key (or other provider keys like `ANTHROPIC_API_KEY`).
  </Property>
  <Property name="GEMINI_API_KEY" type="string">
    Google AI Studio provider key for Cloudflare mode.
  </Property>
  <Property name="OPENROUTER_API_KEY" type="string">
    OpenRouter provider key for Cloudflare mode.
  </Property>
  <Property name="REPLICATE_API_TOKEN" type="string">
    Replicate provider token for Cloudflare mode.
  </Property>
